...
BASE_EM_3B = Path(r"D:\PDF novos\PROJETO_DE_VIDA\EM\3_BIMESTRE")
...
def main() -> None:
    pastas = [BASE_EM_3B / nome for nome in ("1_ANO", "2_ANO", "3_ANO")]
    print("Padronizacao de Projeto de Vida EM - 3o bimestre")
    for pasta in pastas:
