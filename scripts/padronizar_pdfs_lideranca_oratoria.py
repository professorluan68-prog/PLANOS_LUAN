...
BASE_LIDERANCA_3B = Path(r"D:\PDF novos\LIDERANCA_E_ORATORIA\EM\3_BIMESTRE")
...
def padronizar_pasta(pasta: Path) -> dict[str, int]:
    pasta = pasta.resolve()
    base = BASE_LIDERANCA_3B.resolve()
...
def main() -> None:
    print("Padronizacao de Lideranca e Oratoria EM - 3o bimestre")
    for pasta in sorted(caminho for caminho in BASE_LIDERANCA_3B.iterdir() if caminho.is_dir()):
