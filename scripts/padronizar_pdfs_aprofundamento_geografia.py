...
BASE_APROF_GEO_3B = Path(r"D:\PDF novos\APROFUNDAMENTO_EM_GEOGRAFIA\EM\3_BIMESTRE")
...
def padronizar_pasta(pasta: Path) -> dict[str, int]:
    pasta = pasta.resolve()
    base = BASE_APROF_GEO_3B.resolve()
...
def main() -> None:
    print("Padronizacao de Aprofundamento em Geografia EM - 3o bimestre")
    for pasta in sorted(caminho for caminho in BASE_APROF_GEO_3B.iterdir() if caminho.is_dir()):
