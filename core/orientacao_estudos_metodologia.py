...
def _blocos_especificos_jornada_13(texto_pdf: str) -> dict[str, str] | None:
    ...
    if any(chave in base for chave in ["amigos virtuais", "redes sociais", "vinculos", "campanha de conscientizacao", "orgaos de saude", "vacin"]):
        return {
            ...
            "foco": "Explicar que charges e campanhas publicitarias institucionais usam recursos midiaticos diferentes para refletir sobre vinculos sociais, saude e responsabilidade coletiva, pois ambos dependem da articulacao entre linguagem verbal e visual para produzir efeito no leitor. Relacionar essa ideia aos materiais da aula.",
