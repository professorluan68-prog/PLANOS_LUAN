...
def higienizar_string(texto: str, perfil_pedagogico: str, recursos_reais: dict) -> str:
    ...
    if perfil_pedagogico not in {"jornalistico_valido", "noticia_multimodal"}:
        regras_compiladas = _REGRAS_COMPILADAS.get(perfil_pedagogico, _REGRAS_COMPILADAS["geral_nao_jornalistica"])
        for padrao_compilado, subst in regras_compiladas:
